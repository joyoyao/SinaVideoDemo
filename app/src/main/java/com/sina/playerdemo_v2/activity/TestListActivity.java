...
public class TestListActivity extends Activity implements
	...
	protected void prepareTestData() {
		String TEST_THUMB_URL = VideoConstant.videoThumbList[0];
		String TEST_THUMB_URL2 = VideoConstant.videoThumbList[1];
		String TEST_PLAY_URL =  VideoConstant.videoUrlList[0];
		String TEST_PLAY_URL2 = VideoConstant.videoUrlList[2];
